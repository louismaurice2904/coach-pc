    ...
    <div style={{ minHeight: '100vh', background: '#070b18', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <div style={{ width: '100%', maxWidth: 440, padding: '0 24px' }}>
        <div style={{
          ...
          border: '1px solid rgba(255,255,255,0.08)', borderRadius: 24, padding: 36, textAlign: 'center'
        }}>
          <p style={{ fontSize: 48, marginBottom: 16 }}>📬</p>
          <h2 style={{ fontSize: 22, fontWeight: 900, color: 'white', marginBottom: 8 }}>Vérifie ton email !</h2>
          <p style={{ color: 'rgba(255,255,255,0.45)', fontSize: 14, marginBottom: 28, lineHeight: 1.7 }}>
      ...
      <div style={{ width: '100%', maxWidth: 440, padding: '0 24px', position: 'relative', zIndex: 1 }}>
        ...
        <div className="glass" style={{ borderRadius: 24, padding: 36 }}>
          <div style={{ textAlign: 'center', marginBottom: 28 }}>
            ...
            <h1 style={{ fontSize: 22, fontWeight: 900, color: 'white', marginBottom: 6 }}>Crée ton compte</h1>
            <p style={{ color: 'rgba(255,255,255,0.4)', fontSize: 14 }}>Commence à réviser intelligemment</p>
          </div>
          ...
          <button onClick={handleInscription} disabled={loading} className="glow-btn" style={{
          ...
          <p style={{ textAlign: 'center', fontSize: 13, color: 'rgba(255,255,255,0.35)', marginTop: 24 }}>
            Déjà un compte ?{' '}
            <Link href="/connexion" style={{ color: '#38bdf8', fontWeight: 600, textDecoration: 'none' }}>
              Se connecter
            </Link>
          </p>
        </div>
