    ...
    <div style={{ minHeight: '100vh', background: '#060d2e' }}>
      ...
      <div style={{ maxWidth: 700, margin: '0 auto', padding: '40px 24px', position: 'relative', zIndex: 1 }}>
        <div className="glass" style={{ borderRadius: 24, padding: 36 }}>
          ...
          <p>CoachPC est édité à titre personnel par Louis Maurice. Pour tout contact : <a href="mailto:contact@coachpc.fr">contact@coachpc.fr</a></p>
          ...
          <p>CoachPC collecte les données suivantes :</p>
          <ul>
          ...
          <p>Conformément au RGPD, vous disposez des droits d'accès, rectification, suppression, portabilité et opposition. Pour exercer ces droits : <a href="mailto:contact@coachpc.fr">contact@coachpc.fr</a></p>

          <h2>6. Cookies</h2>
          <p>CoachPC utilise uniquement des cookies techniques nécessaires au fonctionnement du service (session d'authentification). Aucun cookie publicitaire ou de tracking n'est utilisé.</p>

          <h2>7. Conditions générales d'utilisation</h2>
          <p>En utilisant CoachPC, l'utilisateur s'engage à :</p>
          <ul>
          ...
          <p style={{ marginTop: 12 }}>CoachPC se réserve le droit de suspendre tout compte en cas de non-respect de ces conditions.</p>

          <h2>8. Propriété intellectuelle</h2>
          <p>L'ensemble du contenu de CoachPC (textes, design, code, logo) est protégé par le droit d'auteur. Toute reproduction sans autorisation est interdite.</p>

          <h2>9. Limitation de responsabilité</h2>
          <p>CoachPC est un outil d'aide à la révision. Les contenus générés par l'IA sont fournis à titre indicatif et ne sauraient se substituer à l'enseignement d'un professeur qualifié. CoachPC ne saurait être tenu responsable des résultats scolaires de l'élève.</p>
