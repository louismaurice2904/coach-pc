      ...
      <div style={{ position: 'relative', zIndex: 2, padding: isMobile ? '50px 20px' : '80px 40px' }}>
        <div style={{ maxWidth: 700, margin: '0 auto' }}>
          <div className="card" style={{ borderRadius: 16, padding: isMobile ? 24 : 36 }}>
            ...
            <p style={{ color: 'rgba(255,255,255,0.5)', fontSize: 14, lineHeight: 1.8 }}>
              Novalys est né de l'expérience directe de la préparation au bac — la difficulté de s'organiser seul, sans savoir par où commencer. C'est cette expérience qui guide chaque fonctionnalité du produit, pensée pour vraiment aider un lycéen à progresser, pas juste à gagner du temps sur ses devoirs.
            </p>
          </div>
        </div>
      </div>
